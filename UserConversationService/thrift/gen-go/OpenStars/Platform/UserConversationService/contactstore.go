...
package UserConversationService
...
type TValue struct {
  ...
  Listcid []int64 `thrift:"listcid,2" db:"listcid" json:"listcid"`
}
...
func (p *TValue) GetListcid() []int64 {
  return p.Listcid
}
...
var _elem0 int64
    ...
    p.Listcid = append(p.Listcid, _elem0)
  }
...
func (p *TValue) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("listcid", thrift.LIST, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:listcid: ", p), err) }
  if err := oprot.WriteListBegin(thrift.I64, len(p.Listcid)); err != nil {
    return thrift.PrependError("error writing list begin: ", err)
  }
  for _, v := range p.Listcid {
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 2:listcid: ", p), err) }
  return err
}
...
type TDataService interface {
  ...
  //  - Key
  //  - Cid
  AddConversation(ctx context.Context, key TKey, cid int64) (r TErrorCode, err error)
  // Parameters:
  //  - Key
  //  - Cid
  RemoveConversation(ctx context.Context, key TKey, cid int64) (r TErrorCode, err error)
}
...
//  - Key
//  - Cid
func (p *TDataServiceClient) AddConversation(ctx context.Context, key TKey, cid int64) (r TErrorCode, err error) {
  var _args10 TDataServiceAddConversationArgs
  _args10.Key = key
  _args10.Cid = cid
  var _result11 TDataServiceAddConversationResult
  if err = p.c.Call(ctx, "addConversation", &_args10, &_result11); err != nil {
    return
  }
...
//  - Key
//  - Cid
func (p *TDataServiceClient) RemoveConversation(ctx context.Context, key TKey, cid int64) (r TErrorCode, err error) {
  var _args12 TDataServiceRemoveConversationArgs
  _args12.Key = key
  _args12.Cid = cid
  var _result13 TDataServiceRemoveConversationResult
  if err = p.c.Call(ctx, "removeConversation", &_args12, &_result13); err != nil {
    return
  }
...
func NewTDataServiceProcessor(handler TDataService) *TDataServiceProcessor {
  ...
  self14.processorMap["addConversation"] = &tDataServiceProcessorAddConversation{handler:handler}
  self14.processorMap["removeConversation"] = &tDataServiceProcessorRemoveConversation{handler:handler}
return self14
}
...
var retval TErrorCode
  var err2 error
  if retval, err2 = p.handler.AddConversation(ctx, args.Key, args.Cid); err2 != nil {
...
type tDataServiceProcessorRemoveConversation struct {
  handler TDataService
}

func (p *tDataServiceProcessorRemoveConversation) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TDataServiceRemoveConversationArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin("removeConversation", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush()
    return false, err
  ...
  iprot.ReadMessageEnd()
  result := TDataServiceRemoveConversationResult{}
var retval TErrorCode
  var err2 error
  if retval, err2 = p.handler.RemoveConversation(ctx, args.Key, args.Cid); err2 != nil {
    x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing removeConversation: " + err2.Error())
    oprot.WriteMessageBegin("removeConversation", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush()
  ...
  if err2 = oprot.WriteMessageBegin("removeConversation", thrift.REPLY, seqId); err2 != nil {
    err = err2
  }
  if err2 = result.Write(oprot); err == nil && err2 != nil {
    err = err2
...
func (p *TDataServiceAddConversationArgs) GetKey() TKey {
  return p.Key
}
...
//  - Key
//  - Cid
type TDataServiceRemoveConversationArgs struct {
  Key TKey `thrift:"key,1" db:"key" json:"key"`
  Cid int64 `thrift:"cid,2" db:"cid" json:"cid"`
}

func NewTDataServiceRemoveConversationArgs() *TDataServiceRemoveConversationArgs {
  return &TDataServiceRemoveConversationArgs{}
}


func (p *TDataServiceRemoveConversationArgs) GetKey() TKey {
  return p.Key
}

func (p *TDataServiceRemoveConversationArgs) GetCid() int64 {
  return p.Cid
}
func (p *TDataServiceRemoveConversationArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceRemoveConversationArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := TKey(v)
...
func (p *TDataServiceRemoveConversationArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Cid = v
...
func (p *TDataServiceRemoveConversationArgs) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("removeConversation_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *TDataServiceRemoveConversationArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("key", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:key: ", p), err) }
  if err := oprot.WriteI64(int64(p.Key)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.key (1) field write error: ", p), err) }
...
func (p *TDataServiceRemoveConversationArgs) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("cid", thrift.I64, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:cid: ", p), err) }
  if err := oprot.WriteI64(int64(p.Cid)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.cid (2) field write error: ", p), err) }
...
func (p *TDataServiceRemoveConversationArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceRemoveConversationArgs(%+v)", *p)
}

// Attributes:
//  - Success
type TDataServiceRemoveConversationResult struct {
  Success *TErrorCode `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewTDataServiceRemoveConversationResult() *TDataServiceRemoveConversationResult {
  return &TDataServiceRemoveConversationResult{}
}

var TDataServiceRemoveConversationResult_Success_DEFAULT TErrorCode
func (p *TDataServiceRemoveConversationResult) GetSuccess() TErrorCode {
  if !p.IsSetSuccess() {
    return TDataServiceRemoveConversationResult_Success_DEFAULT
  }
return *p.Success
}
func (p *TDataServiceRemoveConversationResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *TDataServiceRemoveConversationResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceRemoveConversationResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  temp := TErrorCode(v)
...
func (p *TDataServiceRemoveConversationResult) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("removeConversation_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
...
func (p *TDataServiceRemoveConversationResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *TDataServiceRemoveConversationResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceRemoveConversationResult(%+v)", *p)
}


type TUserConversationService interface {
TDataService
}

type TUserConversationServiceClient struct {
  c thrift.TClient
  *TDataServiceClient
}

// Deprecated: Use NewTUserConversationService instead
func NewTUserConversationServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TUserConversationServiceClient {
  return &TUserConversationServiceClient{TDataServiceClient: NewTDataServiceClientFactory(t, f)}}

// Deprecated: Use NewTUserConversationService instead
func NewTUserConversationServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *TUserConversationServiceClient {
  return &TUserConversationServiceClient{TDataServiceClient: NewTDataServiceClientProtocol(t, iprot, oprot)}
}

func NewTUserConversationServiceClient(c thrift.TClient) *TUserConversationServiceClient {
  return &TUserConversationServiceClient{
    c: c,
    TDataServiceClient: NewTDataServiceClient(c),
  }
}

type TUserConversationServiceProcessor struct {
  *TDataServiceProcessor
}

func NewTUserConversationServiceProcessor(handler TUserConversationService) *TUserConversationServiceProcessor {
  self28 := &TUserConversationServiceProcessor{NewTDataServiceProcessor(handler)}
  return self28
}
