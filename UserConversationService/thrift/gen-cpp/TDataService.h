...
class TDataServiceIf {
 public:
  ...
  virtual TErrorCode::type addConversation(const TKey key, const int64_t cid) = 0;
  virtual TErrorCode::type removeConversation(const TKey key, const int64_t cid) = 0;
};
...
class TDataServiceNull : virtual public TDataServiceIf {
 public:
  ...
  TErrorCode::type addConversation(const TKey /* key */, const int64_t /* cid */) {
    TErrorCode::type _return = (TErrorCode::type)0;
    return _return;
  }
  TErrorCode::type removeConversation(const TKey /* key */, const int64_t /* cid */) {
    TErrorCode::type _return = (TErrorCode::type)0;
    return _return;
  }
};
...
typedef struct _TDataService_addConversation_args__isset {
  _TDataService_addConversation_args__isset() : key(false), cid(false) {}
  bool key :1;
  bool cid :1;
...
class TDataService_addConversation_args {
 public:
  ...
  TDataService_addConversation_args() : key(0), cid(0) {
  }
...
typedef struct _TDataService_removeConversation_args__isset {
  _TDataService_removeConversation_args__isset() : key(false), cid(false) {}
  bool key :1;
  bool cid :1;
} _TDataService_removeConversation_args__isset;

class TDataService_removeConversation_args {
 public:

  TDataService_removeConversation_args(const TDataService_removeConversation_args&);
  TDataService_removeConversation_args& operator=(const TDataService_removeConversation_args&);
  TDataService_removeConversation_args() : key(0), cid(0) {
  }

  virtual ~TDataService_removeConversation_args() throw();
  TKey key;
  int64_t cid;

  _TDataService_removeConversation_args__isset __isset;

  void __set_key(const TKey val);

  void __set_cid(const int64_t val);

  bool operator == (const TDataService_removeConversation_args & rhs) const
  {
    if (!(key == rhs.key))
      return false;
    if (!(cid == rhs.cid))
  ...
  bool operator < (const TDataService_removeConversation_args & ) const;
...
class TDataService_removeConversation_pargs {
 public:


  virtual ~TDataService_removeConversation_pargs() throw();
  const TKey* key;
  const int64_t* cid;
...
typedef struct _TDataService_removeConversation_result__isset {
  _TDataService_removeConversation_result__isset() : success(false) {}
  bool success :1;
} _TDataService_removeConversation_result__isset;

class TDataService_removeConversation_result {
 public:

  TDataService_removeConversation_result(const TDataService_removeConversation_result&);
  TDataService_removeConversation_result& operator=(const TDataService_removeConversation_result&);
  TDataService_removeConversation_result() : success((TErrorCode::type)0) {
  }

  virtual ~TDataService_removeConversation_result() throw();
  TErrorCode::type success;

  _TDataService_removeConversation_result__isset __isset;

  void __set_success(const TErrorCode::type val);

  bool operator == (const TDataService_removeConversation_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TDataService_removeConversation_result & ) const;
...
typedef struct _TDataService_removeConversation_presult__isset {
  _TDataService_removeConversation_presult__isset() : success(false) {}
  bool success :1;
} _TDataService_removeConversation_presult__isset;

class TDataService_removeConversation_presult {
 public:


  virtual ~TDataService_removeConversation_presult() throw();
  TErrorCode::type* success;

  _TDataService_removeConversation_presult__isset __isset;
...
class TDataServiceClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type addConversation(const TKey key, const int64_t cid);
  void send_addConversation(const TKey key, const int64_t cid);
  TErrorCode::type recv_addConversation();
  TErrorCode::type removeConversation(const TKey key, const int64_t cid);
  void send_removeConversation(const TKey key, const int64_t cid);
  TErrorCode::type recv_removeConversation();
 protected:
...
class TDataServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_removeConversation(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  TDataServiceProcessor(::apache::thrift::stdcxx::shared_ptr<TDataServiceIf> iface) :
    ...
    processMap_["removeConversation"] = &TDataServiceProcessor::process_removeConversation;
  }
...
class TDataServiceMultiface : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type addConversation(const TKey key, const int64_t cid) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->addConversation(key, cid);
    }
    return ifaces_[i]->addConversation(key, cid);
  }
  ...
  TErrorCode::type removeConversation(const TKey key, const int64_t cid) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->removeConversation(key, cid);
    }
    return ifaces_[i]->removeConversation(key, cid);
  }
...
class TDataServiceConcurrentClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type addConversation(const TKey key, const int64_t cid);
  int32_t send_addConversation(const TKey key, const int64_t cid);
  TErrorCode::type recv_addConversation(const int32_t seqid);
  TErrorCode::type removeConversation(const TKey key, const int64_t cid);
  int32_t send_removeConversation(const TKey key, const int64_t cid);
  TErrorCode::type recv_removeConversation(const int32_t seqid);
 protected:
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
