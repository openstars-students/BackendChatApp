...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/userconversationServiced

bin/userconversationServiced: ../../corelibs/OpenStorage/lib/libopenstoraged.a

bin/userconversationServiced: ../../corelibs/BaseFoundation/lib/libbasefoundationd.a

bin/userconversationServiced: ../../contribs/ApacheThrift/lib/libapachethriftd.a

bin/userconversationServiced: ../../contribs/SpecialContribs/lib/libspecialcontribsd.a

bin/userconversationServiced: ../../contribs/Poco/lib/libpocoalld.a

bin/userconversationServiced: ../../contribs/LibEvent/lib/libeventd.a

bin/userconversationServiced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/userconversationServiced ${OBJECTFILES} ${LDLIBSOPTIONS}
