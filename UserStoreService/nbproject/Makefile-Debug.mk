...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/userstoreserviced

bin/userstoreserviced: ../../corelibs/OpenStorage/lib/libopenstoraged.a

bin/userstoreserviced: ../../corelibs/BaseFoundation/lib/libbasefoundationd.a

bin/userstoreserviced: ../../contribs/ApacheThrift/lib/libapachethriftd.a

bin/userstoreserviced: ../../contribs/SpecialContribs/lib/libspecialcontribsd.a

bin/userstoreserviced: ../../contribs/Poco/lib/libpocoalld.a

bin/userstoreserviced: ../../contribs/LibEvent/lib/libeventd.a

bin/userstoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/userstoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
