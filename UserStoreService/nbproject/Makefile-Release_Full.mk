...
OBJECTFILES= \
	...
	${OBJECTDIR}/thrift/gen-cpp/TUserStoreService.o \
	${OBJECTDIR}/thrift/gen-cpp/userstore_constants.o \
	${OBJECTDIR}/thrift/gen-cpp/userstore_types.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/userstoreservice

bin/userstoreservice: ../../corelibs/CuteStorage/lib/libcutestorage.a

bin/userstoreservice: ../../corelibs/OpenStorage/lib/libopenstorage.a

bin/userstoreservice: ../../corelibs/BaseFoundation/lib/libbasefoundation.a

bin/userstoreservice: ../../contribs/ApacheThrift/lib/libapachethrift.a

bin/userstoreservice: ../../contribs/SpecialContribs/lib/libspecialcontribs.a

bin/userstoreservice: ../../contribs/Poco/lib/libpocoall.a

bin/userstoreservice: ../../contribs/LibEvent/lib/libevent.a

bin/userstoreservice: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/userstoreservice ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/thrift/gen-cpp/TUserStoreService.o: thrift/gen-cpp/TUserStoreService.cpp
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -Iinc -I../../contribs/LibEvent/include -I../../contribs/Boost/include -I../../contribs/Poco/include -I../../contribs/ApacheThrift/include -I../../contribs/SpecialContribs/include -Ithrift/gen-cpp -I../../contribs/SpecialContribs/src/hashkit -I../../contribs/SpecialContribs/src/libstatgrab -I../../contribs/SpecialContribs/include/kyotocabinet -I../../contribs/SpecialContribs/include/leveldb -I../../contribs/SpecialContribs/src/ -I../../corelibs/BaseFoundation/include -I../../corelibs/OpenStorage/inc -I../../corelibs/BaseFoundation/thrift/gen-cpp -IClient -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TUserStoreService.o thrift/gen-cpp/TUserStoreService.cpp

${OBJECTDIR}/thrift/gen-cpp/userstore_constants.o: thrift/gen-cpp/userstore_constants.cpp
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -Iinc -I../../contribs/LibEvent/include -I../../contribs/Boost/include -I../../contribs/Poco/include -I../../contribs/ApacheThrift/include -I../../contribs/SpecialContribs/include -Ithrift/gen-cpp -I../../contribs/SpecialContribs/src/hashkit -I../../contribs/SpecialContribs/src/libstatgrab -I../../contribs/SpecialContribs/include/kyotocabinet -I../../contribs/SpecialContribs/include/leveldb -I../../contribs/SpecialContribs/src/ -I../../corelibs/BaseFoundation/include -I../../corelibs/OpenStorage/inc -I../../corelibs/BaseFoundation/thrift/gen-cpp -IClient -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/userstore_constants.o thrift/gen-cpp/userstore_constants.cpp

${OBJECTDIR}/thrift/gen-cpp/userstore_types.o: thrift/gen-cpp/userstore_types.cpp
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -Iinc -I../../contribs/LibEvent/include -I../../contribs/Boost/include -I../../contribs/Poco/include -I../../contribs/ApacheThrift/include -I../../contribs/SpecialContribs/include -Ithrift/gen-cpp -I../../contribs/SpecialContribs/src/hashkit -I../../contribs/SpecialContribs/src/libstatgrab -I../../contribs/SpecialContribs/include/kyotocabinet -I../../contribs/SpecialContribs/include/leveldb -I../../contribs/SpecialContribs/src/ -I../../corelibs/BaseFoundation/include -I../../corelibs/OpenStorage/inc -I../../corelibs/BaseFoundation/thrift/gen-cpp -IClient -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/userstore_types.o thrift/gen-cpp/userstore_types.cpp
