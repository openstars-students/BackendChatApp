...
void TValue::__set_listmid(const std::vector<int64_t> & val) {
  this->listmid = val;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->listmid.resize(_size0);
            uint32_t _i4;
            for (_i4 = 0; _i4 < _size0; ++_i4)
            {
              xfer += iprot->readI64(this->listmid[_i4]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.listmid = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TValue::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("listmid", ::apache::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->listmid.size()));
    std::vector<int64_t> ::const_iterator _iter5;
    for (_iter5 = this->listmid.begin(); _iter5 != this->listmid.end(); ++_iter5)
    {
