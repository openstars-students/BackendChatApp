 ...
 *  @generated
 */
#ifndef listmessageservice_TYPES_H
#define listmessageservice_TYPES_H
...
typedef struct _TValue__isset {
  _TValue__isset() : uid(false), listmid(false) {}
  bool uid :1;
  bool listmid :1;
} _TValue__isset;
...
class TValue : public virtual ::apache::thrift::TBase {
 public:
  ...
  TKey uid;
  std::vector<int64_t>  listmid;

  _TValue__isset __isset;

  void __set_uid(const TKey val);

  void __set_listmid(const std::vector<int64_t> & val);

  bool operator == (const TValue & rhs) const
  {
    if (!(uid == rhs.uid))
      return false;
    if (!(listmid == rhs.listmid))
      return false;
    return true;
  }
  bool operator != (const TValue &rhs) const {
