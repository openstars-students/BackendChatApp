...
import (
        ...
        "OpenStars/Platform/ListMessageService"
)
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TErrorCode addMessage(TKey key, i64 mid)")
  fmt.Fprintln(os.Stderr, "  TErrorCode removeMessage(TKey key, i64 mid)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := ListMessageService.NewTListMessageServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getData":
    ...
    value0 := ListMessageService.TKey(argvalue0)
  ...
  case "putData":
    ...
    argvalue1 := ListMessageService.NewTValue()
  ...
  case "addMessage":
    ...
    value1 := argvalue1
    fmt.Print(client.AddMessage(context.Background(), value0, value1))
    fmt.Print("\n")
    break
  case "removeMessage":
    if flag.NArg() - 1 != 2 {
      fmt.Fprintln(os.Stderr, "RemoveMessage requires 2 args")
      flag.Usage()
    }
    ...
    value1 := argvalue1
    fmt.Print(client.RemoveMessage(context.Background(), value0, value1))
    fmt.Print("\n")
    break
  case "":
    Usage()
