...
class TDataServiceIf {
 public:
  ...
  virtual TErrorCode::type addMember(const TKey key, const int64_t uid) = 0;
  virtual TErrorCode::type removeMember(const TKey key, const int64_t uid) = 0;
};
...
class TDataServiceNull : virtual public TDataServiceIf {
 public:
  ...
  TErrorCode::type addMember(const TKey /* key */, const int64_t /* uid */) {
    TErrorCode::type _return = (TErrorCode::type)0;
    return _return;
  }
  TErrorCode::type removeMember(const TKey /* key */, const int64_t /* uid */) {
    TErrorCode::type _return = (TErrorCode::type)0;
    return _return;
  }
};
...
typedef struct _TDataService_addMember_args__isset {
  _TDataService_addMember_args__isset() : key(false), uid(false) {}
  bool key :1;
  bool uid :1;
} _TDataService_addMember_args__isset;

class TDataService_addMember_args {
 public:

  TDataService_addMember_args(const TDataService_addMember_args&);
  TDataService_addMember_args& operator=(const TDataService_addMember_args&);
  TDataService_addMember_args() : key(0), uid(0) {
  }

  virtual ~TDataService_addMember_args() throw();
  TKey key;
  int64_t uid;

  _TDataService_addMember_args__isset __isset;

  void __set_key(const TKey val);

  void __set_uid(const int64_t val);

  bool operator == (const TDataService_addMember_args & rhs) const
  {
    if (!(key == rhs.key))
      return false;
    if (!(uid == rhs.uid))
  ...
  bool operator < (const TDataService_addMember_args & ) const;
...
class TDataService_addMember_pargs {
 public:


  virtual ~TDataService_addMember_pargs() throw();
  const TKey* key;
  const int64_t* uid;
...
typedef struct _TDataService_addMember_result__isset {
  _TDataService_addMember_result__isset() : success(false) {}
  bool success :1;
} _TDataService_addMember_result__isset;

class TDataService_addMember_result {
 public:

  TDataService_addMember_result(const TDataService_addMember_result&);
  TDataService_addMember_result& operator=(const TDataService_addMember_result&);
  TDataService_addMember_result() : success((TErrorCode::type)0) {
  }

  virtual ~TDataService_addMember_result() throw();
  TErrorCode::type success;

  _TDataService_addMember_result__isset __isset;

  void __set_success(const TErrorCode::type val);

  bool operator == (const TDataService_addMember_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TDataService_addMember_result & ) const;
...
typedef struct _TDataService_addMember_presult__isset {
  _TDataService_addMember_presult__isset() : success(false) {}
  bool success :1;
} _TDataService_addMember_presult__isset;

class TDataService_addMember_presult {
 public:


  virtual ~TDataService_addMember_presult() throw();
  TErrorCode::type* success;

  _TDataService_addMember_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _TDataService_removeMember_args__isset {
  _TDataService_removeMember_args__isset() : key(false), uid(false) {}
  bool key :1;
  bool uid :1;
} _TDataService_removeMember_args__isset;

class TDataService_removeMember_args {
 public:

  TDataService_removeMember_args(const TDataService_removeMember_args&);
  TDataService_removeMember_args& operator=(const TDataService_removeMember_args&);
  TDataService_removeMember_args() : key(0), uid(0) {
  }

  virtual ~TDataService_removeMember_args() throw();
  TKey key;
  int64_t uid;

  _TDataService_removeMember_args__isset __isset;

  void __set_key(const TKey val);

  void __set_uid(const int64_t val);

  bool operator == (const TDataService_removeMember_args & rhs) const
  {
    if (!(key == rhs.key))
      return false;
    if (!(uid == rhs.uid))
  ...
  bool operator < (const TDataService_removeMember_args & ) const;
...
class TDataService_removeMember_pargs {
 public:


  virtual ~TDataService_removeMember_pargs() throw();
  const TKey* key;
  const int64_t* uid;
...
typedef struct _TDataService_removeMember_result__isset {
  _TDataService_removeMember_result__isset() : success(false) {}
  bool success :1;
} _TDataService_removeMember_result__isset;

class TDataService_removeMember_result {
 public:

  TDataService_removeMember_result(const TDataService_removeMember_result&);
  TDataService_removeMember_result& operator=(const TDataService_removeMember_result&);
  TDataService_removeMember_result() : success((TErrorCode::type)0) {
  }

  virtual ~TDataService_removeMember_result() throw();
  TErrorCode::type success;

  _TDataService_removeMember_result__isset __isset;

  void __set_success(const TErrorCode::type val);

  bool operator == (const TDataService_removeMember_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TDataService_removeMember_result & ) const;
...
typedef struct _TDataService_removeMember_presult__isset {
  _TDataService_removeMember_presult__isset() : success(false) {}
  bool success :1;
} _TDataService_removeMember_presult__isset;

class TDataService_removeMember_presult {
 public:


  virtual ~TDataService_removeMember_presult() throw();
  TErrorCode::type* success;

  _TDataService_removeMember_presult__isset __isset;
...
class TDataServiceClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type addMember(const TKey key, const int64_t uid);
  void send_addMember(const TKey key, const int64_t uid);
  TErrorCode::type recv_addMember();
  TErrorCode::type removeMember(const TKey key, const int64_t uid);
  void send_removeMember(const TKey key, const int64_t uid);
  TErrorCode::type recv_removeMember();
 protected:
...
class TDataServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_addMember(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_removeMember(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  TDataServiceProcessor(::apache::thrift::stdcxx::shared_ptr<TDataServiceIf> iface) :
    ...
    processMap_["addMember"] = &TDataServiceProcessor::process_addMember;
    processMap_["removeMember"] = &TDataServiceProcessor::process_removeMember;
  }
...
class TDataServiceMultiface : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type addMember(const TKey key, const int64_t uid) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->addMember(key, uid);
    }
    return ifaces_[i]->addMember(key, uid);
  }
  ...
  TErrorCode::type removeMember(const TKey key, const int64_t uid) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->removeMember(key, uid);
    }
    return ifaces_[i]->removeMember(key, uid);
  }
...
class TDataServiceConcurrentClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type addMember(const TKey key, const int64_t uid);
  int32_t send_addMember(const TKey key, const int64_t uid);
  TErrorCode::type recv_addMember(const int32_t seqid);
  TErrorCode::type removeMember(const TKey key, const int64_t uid);
  int32_t send_removeMember(const TKey key, const int64_t uid);
  TErrorCode::type recv_removeMember(const int32_t seqid);
 protected:
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
