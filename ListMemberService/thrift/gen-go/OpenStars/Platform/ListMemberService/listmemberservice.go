...
type TValue struct {
  ...
  Listuid []int64 `thrift:"listuid,2" db:"listuid" json:"listuid"`
}
...
func (p *TValue) GetListuid() []int64 {
  return p.Listuid
}
...
var _elem0 int64
    ...
    p.Listuid = append(p.Listuid, _elem0)
  }
...
func (p *TValue) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("listuid", thrift.LIST, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:listuid: ", p), err) }
  if err := oprot.WriteListBegin(thrift.I64, len(p.Listuid)); err != nil {
    return thrift.PrependError("error writing list begin: ", err)
  }
  for _, v := range p.Listuid {
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 2:listuid: ", p), err) }
  return err
}
...
type TDataService interface {
  ...
  //  - Key
  //  - UID
  AddMember(ctx context.Context, key TKey, uid int64) (r TErrorCode, err error)
  // Parameters:
  //  - Key
  //  - UID
  RemoveMember(ctx context.Context, key TKey, uid int64) (r TErrorCode, err error)
}
...
//  - Key
//  - UID
func (p *TDataServiceClient) AddMember(ctx context.Context, key TKey, uid int64) (r TErrorCode, err error) {
  var _args10 TDataServiceAddMemberArgs
  _args10.Key = key
  _args10.UID = uid
  var _result11 TDataServiceAddMemberResult
  if err = p.c.Call(ctx, "addMember", &_args10, &_result11); err != nil {
    return
  }
...
//  - Key
//  - UID
func (p *TDataServiceClient) RemoveMember(ctx context.Context, key TKey, uid int64) (r TErrorCode, err error) {
  var _args12 TDataServiceRemoveMemberArgs
  _args12.Key = key
  _args12.UID = uid
  var _result13 TDataServiceRemoveMemberResult
  if err = p.c.Call(ctx, "removeMember", &_args12, &_result13); err != nil {
    return
  }
...
func NewTDataServiceProcessor(handler TDataService) *TDataServiceProcessor {
  ...
  self14.processorMap["addMember"] = &tDataServiceProcessorAddMember{handler:handler}
  self14.processorMap["removeMember"] = &tDataServiceProcessorRemoveMember{handler:handler}
return self14
}
...
type tDataServiceProcessorAddMember struct {
  handler TDataService
}

func (p *tDataServiceProcessorAddMember) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TDataServiceAddMemberArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  iprot.ReadMessageEnd()
  result := TDataServiceAddMemberResult{}
var retval TErrorCode
  var err2 error
  if retval, err2 = p.handler.AddMember(ctx, args.Key, args.UID); err2 != nil {
...
type tDataServiceProcessorRemoveMember struct {
  handler TDataService
}

func (p *tDataServiceProcessorRemoveMember) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TDataServiceRemoveMemberArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  iprot.ReadMessageEnd()
  result := TDataServiceRemoveMemberResult{}
var retval TErrorCode
  var err2 error
  if retval, err2 = p.handler.RemoveMember(ctx, args.Key, args.UID); err2 != nil {
...
//  - Key
//  - UID
type TDataServiceAddMemberArgs struct {
  Key TKey `thrift:"key,1" db:"key" json:"key"`
  UID int64 `thrift:"uid,2" db:"uid" json:"uid"`
}

func NewTDataServiceAddMemberArgs() *TDataServiceAddMemberArgs {
  return &TDataServiceAddMemberArgs{}
}


func (p *TDataServiceAddMemberArgs) GetKey() TKey {
  return p.Key
}

func (p *TDataServiceAddMemberArgs) GetUID() int64 {
  return p.UID
}
func (p *TDataServiceAddMemberArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceAddMemberArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := TKey(v)
...
func (p *TDataServiceAddMemberArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TDataServiceAddMemberArgs) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceAddMemberArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("key", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:key: ", p), err) }
  if err := oprot.WriteI64(int64(p.Key)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.key (1) field write error: ", p), err) }
...
func (p *TDataServiceAddMemberArgs) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *TDataServiceAddMemberArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceAddMemberArgs(%+v)", *p)
}

// Attributes:
//  - Success
type TDataServiceAddMemberResult struct {
  Success *TErrorCode `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewTDataServiceAddMemberResult() *TDataServiceAddMemberResult {
  return &TDataServiceAddMemberResult{}
}

var TDataServiceAddMemberResult_Success_DEFAULT TErrorCode
func (p *TDataServiceAddMemberResult) GetSuccess() TErrorCode {
  if !p.IsSetSuccess() {
    return TDataServiceAddMemberResult_Success_DEFAULT
  }
return *p.Success
}
func (p *TDataServiceAddMemberResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *TDataServiceAddMemberResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceAddMemberResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  temp := TErrorCode(v)
...
func (p *TDataServiceAddMemberResult) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceAddMemberResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *TDataServiceAddMemberResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceAddMemberResult(%+v)", *p)
}

// Attributes:
//  - Key
//  - UID
type TDataServiceRemoveMemberArgs struct {
  Key TKey `thrift:"key,1" db:"key" json:"key"`
  UID int64 `thrift:"uid,2" db:"uid" json:"uid"`
}

func NewTDataServiceRemoveMemberArgs() *TDataServiceRemoveMemberArgs {
  return &TDataServiceRemoveMemberArgs{}
}


func (p *TDataServiceRemoveMemberArgs) GetKey() TKey {
  return p.Key
}

func (p *TDataServiceRemoveMemberArgs) GetUID() int64 {
  return p.UID
}
func (p *TDataServiceRemoveMemberArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceRemoveMemberArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := TKey(v)
...
func (p *TDataServiceRemoveMemberArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.UID = v
...
func (p *TDataServiceRemoveMemberArgs) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceRemoveMemberArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("key", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:key: ", p), err) }
  if err := oprot.WriteI64(int64(p.Key)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.key (1) field write error: ", p), err) }
...
func (p *TDataServiceRemoveMemberArgs) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("uid", thrift.I64, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:uid: ", p), err) }
  if err := oprot.WriteI64(int64(p.UID)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.uid (2) field write error: ", p), err) }
...
func (p *TDataServiceRemoveMemberArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceRemoveMemberArgs(%+v)", *p)
}

// Attributes:
//  - Success
type TDataServiceRemoveMemberResult struct {
  Success *TErrorCode `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewTDataServiceRemoveMemberResult() *TDataServiceRemoveMemberResult {
  return &TDataServiceRemoveMemberResult{}
}

var TDataServiceRemoveMemberResult_Success_DEFAULT TErrorCode
func (p *TDataServiceRemoveMemberResult) GetSuccess() TErrorCode {
  if !p.IsSetSuccess() {
    return TDataServiceRemoveMemberResult_Success_DEFAULT
  }
return *p.Success
}
func (p *TDataServiceRemoveMemberResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *TDataServiceRemoveMemberResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceRemoveMemberResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  temp := TErrorCode(v)
...
func (p *TDataServiceRemoveMemberResult) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceRemoveMemberResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *TDataServiceRemoveMemberResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceRemoveMemberResult(%+v)", *p)
}


type TListMemberService interface {
TDataService
}

type TListMemberServiceClient struct {
  c thrift.TClient
  *TDataServiceClient
}

// Deprecated: Use NewTListMemberService instead
func NewTListMemberServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TListMemberServiceClient {
  return &TListMemberServiceClient{TDataServiceClient: NewTDataServiceClientFactory(t, f)}}

// Deprecated: Use NewTListMemberService instead
func NewTListMemberServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *TListMemberServiceClient {
  return &TListMemberServiceClient{TDataServiceClient: NewTDataServiceClientProtocol(t, iprot, oprot)}
}

func NewTListMemberServiceClient(c thrift.TClient) *TListMemberServiceClient {
  return &TListMemberServiceClient{
    c: c,
    TDataServiceClient: NewTDataServiceClient(c),
  }
}

type TListMemberServiceProcessor struct {
  *TDataServiceProcessor
}

func NewTListMemberServiceProcessor(handler TListMemberService) *TListMemberServiceProcessor {
  self28 := &TListMemberServiceProcessor{NewTDataServiceProcessor(handler)}
  return self28
}
