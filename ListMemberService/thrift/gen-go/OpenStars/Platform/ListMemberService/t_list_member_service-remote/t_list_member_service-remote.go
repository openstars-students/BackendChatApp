...
import (
        ...
        "OpenStars/Platform/ListMemberService"
)
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TErrorCode addMember(TKey key, i64 uid)")
  fmt.Fprintln(os.Stderr, "  TErrorCode removeMember(TKey key, i64 uid)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := ListMemberService.NewTListMemberServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getData":
    ...
    value0 := ListMemberService.TKey(argvalue0)
  ...
  case "putData":
    ...
    argvalue1 := ListMemberService.NewTValue()
  ...
  case "addMember":
    if flag.NArg() - 1 != 2 {
      fmt.Fprintln(os.Stderr, "AddMember requires 2 args")
      flag.Usage()
    }
    ...
    value1 := argvalue1
    fmt.Print(client.AddMember(context.Background(), value0, value1))
    fmt.Print("\n")
    break
  case "removeMember":
    if flag.NArg() - 1 != 2 {
      fmt.Fprintln(os.Stderr, "RemoveMember requires 2 args")
      flag.Usage()
    }
    ...
    value1 := argvalue1
    fmt.Print(client.RemoveMember(context.Background(), value0, value1))
    fmt.Print("\n")
    break
  case "":
    Usage()
