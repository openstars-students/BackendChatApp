...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/contactstoreserviced

bin/contactstoreserviced: ../../corelibs/OpenStorage/lib/libopenstoraged.a

bin/contactstoreserviced: ../../corelibs/BaseFoundation/lib/libbasefoundationd.a

bin/contactstoreserviced: ../../contribs/ApacheThrift/lib/libapachethriftd.a

bin/contactstoreserviced: ../../contribs/SpecialContribs/lib/libspecialcontribsd.a

bin/contactstoreserviced: ../../contribs/Poco/lib/libpocoalld.a

bin/contactstoreserviced: ../../contribs/LibEvent/lib/libeventd.a

bin/contactstoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/contactstoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
