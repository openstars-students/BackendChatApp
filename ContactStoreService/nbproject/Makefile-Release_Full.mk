...
OBJECTFILES= \
	...
	${OBJECTDIR}/thrift/gen-cpp/TContactStoreService.o \
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/contactstoreservice

bin/contactstoreservice: ../../corelibs/CuteStorage/lib/libcutestorage.a

bin/contactstoreservice: ../../corelibs/OpenStorage/lib/libopenstorage.a

bin/contactstoreservice: ../../corelibs/BaseFoundation/lib/libbasefoundation.a

bin/contactstoreservice: ../../contribs/ApacheThrift/lib/libapachethrift.a

bin/contactstoreservice: ../../contribs/SpecialContribs/lib/libspecialcontribs.a

bin/contactstoreservice: ../../contribs/Poco/lib/libpocoall.a

bin/contactstoreservice: ../../contribs/LibEvent/lib/libevent.a

bin/contactstoreservice: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/contactstoreservice ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/thrift/gen-cpp/TContactStoreService.o: thrift/gen-cpp/TContactStoreService.cpp
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -Iinc -I../../contribs/LibEvent/include -I../../contribs/Boost/include -I../../contribs/Poco/include -I../../contribs/ApacheThrift/include -I../../contribs/SpecialContribs/include -Ithrift/gen-cpp -I../../contribs/SpecialContribs/src/hashkit -I../../contribs/SpecialContribs/src/libstatgrab -I../../contribs/SpecialContribs/include/kyotocabinet -I../../contribs/SpecialContribs/include/leveldb -I../../contribs/SpecialContribs/src/ -I../../corelibs/BaseFoundation/include -I../../corelibs/OpenStorage/inc -I../../corelibs/BaseFoundation/thrift/gen-cpp -IClient -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TContactStoreService.o thrift/gen-cpp/TContactStoreService.cpp
