...
type TDataService interface {
  ...
  //  - UID
  //  - Friendid
  AddFriend(ctx context.Context, uid TKey, friendid int64) (r TErrorCode, err error)
  // Parameters:
  //  - UID
  //  - Friendid
  UnFriend(ctx context.Context, uid TKey, friendid int64) (r TErrorCode, err error)
}
...
//  - UID
//  - Friendid
func (p *TDataServiceClient) AddFriend(ctx context.Context, uid TKey, friendid int64) (r TErrorCode, err error) {
  var _args10 TDataServiceAddFriendArgs
  _args10.UID = uid
  _args10.Friendid = friendid
  var _result11 TDataServiceAddFriendResult
  if err = p.c.Call(ctx, "addFriend", &_args10, &_result11); err != nil {
    return
  }
...
//  - UID
//  - Friendid
func (p *TDataServiceClient) UnFriend(ctx context.Context, uid TKey, friendid int64) (r TErrorCode, err error) {
  var _args12 TDataServiceUnFriendArgs
  _args12.UID = uid
  _args12.Friendid = friendid
  var _result13 TDataServiceUnFriendResult
  if err = p.c.Call(ctx, "unFriend", &_args12, &_result13); err != nil {
    return
  }
...
func NewTDataServiceProcessor(handler TDataService) *TDataServiceProcessor {
  ...
  self14.processorMap["addFriend"] = &tDataServiceProcessorAddFriend{handler:handler}
  self14.processorMap["unFriend"] = &tDataServiceProcessorUnFriend{handler:handler}
return self14
}
...
type tDataServiceProcessorAddFriend struct {
  handler TDataService
}

func (p *tDataServiceProcessorAddFriend) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TDataServiceAddFriendArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  iprot.ReadMessageEnd()
  result := TDataServiceAddFriendResult{}
var retval TErrorCode
  var err2 error
  if retval, err2 = p.handler.AddFriend(ctx, args.UID, args.Friendid); err2 != nil {
...
type tDataServiceProcessorUnFriend struct {
  handler TDataService
}

func (p *tDataServiceProcessorUnFriend) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TDataServiceUnFriendArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  iprot.ReadMessageEnd()
  result := TDataServiceUnFriendResult{}
var retval TErrorCode
  var err2 error
  if retval, err2 = p.handler.UnFriend(ctx, args.UID, args.Friendid); err2 != nil {
...
//  - UID
//  - Friendid
type TDataServiceAddFriendArgs struct {
  UID TKey `thrift:"uid,1" db:"uid" json:"uid"`
  Friendid int64 `thrift:"friendid,2" db:"friendid" json:"friendid"`
}

func NewTDataServiceAddFriendArgs() *TDataServiceAddFriendArgs {
  return &TDataServiceAddFriendArgs{}
}


func (p *TDataServiceAddFriendArgs) GetUID() TKey {
  return p.UID
}

func (p *TDataServiceAddFriendArgs) GetFriendid() int64 {
  return p.Friendid
}
func (p *TDataServiceAddFriendArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceAddFriendArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := TKey(v)
...
func (p *TDataServiceAddFriendArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TDataServiceAddFriendArgs) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceAddFriendArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("uid", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:uid: ", p), err) }
  if err := oprot.WriteI64(int64(p.UID)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.uid (1) field write error: ", p), err) }
...
func (p *TDataServiceAddFriendArgs) writeField2(oprot thrift.TProtocol) (err error) {
  ...
  if err := oprot.WriteI64(int64(p.Friendid)); err != nil {
...
func (p *TDataServiceAddFriendArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceAddFriendArgs(%+v)", *p)
}

// Attributes:
//  - Success
type TDataServiceAddFriendResult struct {
  Success *TErrorCode `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewTDataServiceAddFriendResult() *TDataServiceAddFriendResult {
  return &TDataServiceAddFriendResult{}
}

var TDataServiceAddFriendResult_Success_DEFAULT TErrorCode
func (p *TDataServiceAddFriendResult) GetSuccess() TErrorCode {
  if !p.IsSetSuccess() {
    return TDataServiceAddFriendResult_Success_DEFAULT
  }
return *p.Success
}
func (p *TDataServiceAddFriendResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *TDataServiceAddFriendResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceAddFriendResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  temp := TErrorCode(v)
...
func (p *TDataServiceAddFriendResult) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceAddFriendResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *TDataServiceAddFriendResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceAddFriendResult(%+v)", *p)
}

// Attributes:
//  - UID
//  - Friendid
type TDataServiceUnFriendArgs struct {
  UID TKey `thrift:"uid,1" db:"uid" json:"uid"`
  Friendid int64 `thrift:"friendid,2" db:"friendid" json:"friendid"`
}

func NewTDataServiceUnFriendArgs() *TDataServiceUnFriendArgs {
  return &TDataServiceUnFriendArgs{}
}


func (p *TDataServiceUnFriendArgs) GetUID() TKey {
  return p.UID
}

func (p *TDataServiceUnFriendArgs) GetFriendid() int64 {
  return p.Friendid
}
func (p *TDataServiceUnFriendArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceUnFriendArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := TKey(v)
...
func (p *TDataServiceUnFriendArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Friendid = v
...
func (p *TDataServiceUnFriendArgs) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceUnFriendArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("uid", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:uid: ", p), err) }
  if err := oprot.WriteI64(int64(p.UID)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.uid (1) field write error: ", p), err) }
...
func (p *TDataServiceUnFriendArgs) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("friendid", thrift.I64, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:friendid: ", p), err) }
  if err := oprot.WriteI64(int64(p.Friendid)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.friendid (2) field write error: ", p), err) }
...
func (p *TDataServiceUnFriendArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceUnFriendArgs(%+v)", *p)
}

// Attributes:
//  - Success
type TDataServiceUnFriendResult struct {
  Success *TErrorCode `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewTDataServiceUnFriendResult() *TDataServiceUnFriendResult {
  return &TDataServiceUnFriendResult{}
}

var TDataServiceUnFriendResult_Success_DEFAULT TErrorCode
func (p *TDataServiceUnFriendResult) GetSuccess() TErrorCode {
  if !p.IsSetSuccess() {
    return TDataServiceUnFriendResult_Success_DEFAULT
  }
return *p.Success
}
func (p *TDataServiceUnFriendResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *TDataServiceUnFriendResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceUnFriendResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  temp := TErrorCode(v)
...
func (p *TDataServiceUnFriendResult) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceUnFriendResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *TDataServiceUnFriendResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceUnFriendResult(%+v)", *p)
}
...
func NewTContactStoreServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TContactStoreServiceClient {
  return &TContactStoreServiceClient{TDataServiceClient: NewTDataServiceClientFactory(t, f)}}
...
func NewTContactStoreServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *TContactStoreServiceClient {
  return &TContactStoreServiceClient{TDataServiceClient: NewTDataServiceClientProtocol(t, iprot, oprot)}
}
...
func NewTContactStoreServiceProcessor(handler TContactStoreService) *TContactStoreServiceProcessor {
  self28 := &TContactStoreServiceProcessor{NewTDataServiceProcessor(handler)}
  return self28
}
