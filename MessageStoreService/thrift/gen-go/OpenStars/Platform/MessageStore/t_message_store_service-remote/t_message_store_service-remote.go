...
import (
        ...
        "OpenStars/Platform/MessageStore"
)
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TListDataResult getListMessages( listKey)")
  fmt.Fprintln(os.Stderr, "  TErrorCode putData(TKey key, TMessageInfo data)")
  fmt.Fprintln(os.Stderr, "  TErrorCode removeData(TKey key)")
  fmt.Fprintln(os.Stderr, "  TErrorCode deleteLogicData(TKey key)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := MessageStore.NewTMessageStoreServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getData":
    ...
    value0 := MessageStore.TKey(argvalue0)
    fmt.Print(client.GetData(context.Background(), value0))
    fmt.Print("\n")
    break
  case "getListMessages":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetListMessages requires 1 args")
      flag.Usage()
    }
    arg38 := flag.Arg(1)
    ...
    containerStruct0 := MessageStore.NewTMessageStoreServiceGetListMessagesArgs()
    ...
    value0 := argvalue0
    fmt.Print(client.GetListMessages(context.Background(), value0))
    fmt.Print("\n")
    break
  case "putData":
    if flag.NArg() - 1 != 2 {
    ...
    argvalue1 := MessageStore.NewTMessageInfo()
  ...
  case "removeData":
    ...
    fmt.Print("\n")
    break
  case "deleteLogicData":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "DeleteLogicData requires 1 args")
      flag.Usage()
    }
    ...
    value0 := MessageStore.TKey(argvalue0)
    fmt.Print(client.DeleteLogicData(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
