...
OBJECTFILES= \
	...
	${OBJECTDIR}/thrift/gen-cpp/TMessageStoreService.o \
	${OBJECTDIR}/thrift/gen-cpp/messagestore_constants.o \
	${OBJECTDIR}/thrift/gen-cpp/messagestore_types.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/messagestoreservice

bin/messagestoreservice: ../../corelibs/CuteStorage/lib/libcutestorage.a

bin/messagestoreservice: ../../corelibs/OpenStorage/lib/libopenstorage.a

bin/messagestoreservice: ../../corelibs/BaseFoundation/lib/libbasefoundation.a

bin/messagestoreservice: ../../contribs/ApacheThrift/lib/libapachethrift.a

bin/messagestoreservice: ../../contribs/SpecialContribs/lib/libspecialcontribs.a

bin/messagestoreservice: ../../contribs/Poco/lib/libpocoall.a

bin/messagestoreservice: ../../contribs/LibEvent/lib/libevent.a

bin/messagestoreservice: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/messagestoreservice ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/thrift/gen-cpp/TMessageStoreService.o: thrift/gen-cpp/TMessageStoreService.cpp
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -Iinc -I../../contribs/LibEvent/include -I../../contribs/Boost/include -I../../contribs/Poco/include -I../../contribs/ApacheThrift/include -I../../contribs/SpecialContribs/include -Ithrift/gen-cpp -I../../contribs/SpecialContribs/src/hashkit -I../../contribs/SpecialContribs/src/libstatgrab -I../../contribs/SpecialContribs/include/kyotocabinet -I../../contribs/SpecialContribs/include/leveldb -I../../contribs/SpecialContribs/src/ -I../../corelibs/BaseFoundation/include -I../../corelibs/OpenStorage/inc -I../../corelibs/BaseFoundation/thrift/gen-cpp -IClient -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/TMessageStoreService.o thrift/gen-cpp/TMessageStoreService.cpp

${OBJECTDIR}/thrift/gen-cpp/messagestore_constants.o: thrift/gen-cpp/messagestore_constants.cpp
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -Iinc -I../../contribs/LibEvent/include -I../../contribs/Boost/include -I../../contribs/Poco/include -I../../contribs/ApacheThrift/include -I../../contribs/SpecialContribs/include -Ithrift/gen-cpp -I../../contribs/SpecialContribs/src/hashkit -I../../contribs/SpecialContribs/src/libstatgrab -I../../contribs/SpecialContribs/include/kyotocabinet -I../../contribs/SpecialContribs/include/leveldb -I../../contribs/SpecialContribs/src/ -I../../corelibs/BaseFoundation/include -I../../corelibs/OpenStorage/inc -I../../corelibs/BaseFoundation/thrift/gen-cpp -IClient -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/messagestore_constants.o thrift/gen-cpp/messagestore_constants.cpp

${OBJECTDIR}/thrift/gen-cpp/messagestore_types.o: thrift/gen-cpp/messagestore_types.cpp
	${MKDIR} -p ${OBJECTDIR}/thrift/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHAVE_CONFIG_H -Iinc -I../../contribs/LibEvent/include -I../../contribs/Boost/include -I../../contribs/Poco/include -I../../contribs/ApacheThrift/include -I../../contribs/SpecialContribs/include -Ithrift/gen-cpp -I../../contribs/SpecialContribs/src/hashkit -I../../contribs/SpecialContribs/src/libstatgrab -I../../contribs/SpecialContribs/include/kyotocabinet -I../../contribs/SpecialContribs/include/leveldb -I../../contribs/SpecialContribs/src/ -I../../corelibs/BaseFoundation/include -I../../corelibs/OpenStorage/inc -I../../corelibs/BaseFoundation/thrift/gen-cpp -IClient -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift/gen-cpp/messagestore_types.o thrift/gen-cpp/messagestore_types.cpp
