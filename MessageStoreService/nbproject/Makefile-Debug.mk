...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/messagestoreserviced

bin/messagestoreserviced: ../../corelibs/OpenStorage/lib/libopenstoraged.a

bin/messagestoreserviced: ../../corelibs/BaseFoundation/lib/libbasefoundationd.a

bin/messagestoreserviced: ../../contribs/ApacheThrift/lib/libapachethriftd.a

bin/messagestoreserviced: ../../contribs/SpecialContribs/lib/libspecialcontribsd.a

bin/messagestoreserviced: ../../contribs/Poco/lib/libpocoalld.a

bin/messagestoreserviced: ../../contribs/LibEvent/lib/libeventd.a

bin/messagestoreserviced: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/messagestoreserviced ${OBJECTFILES} ${LDLIBSOPTIONS}
